TITLE Mod file for component: Component(id=inh_syn_7conns type=gradedSynapse)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: peer/v, on: Component(id=inh_syn_7conns type=gradedSynapse), from peer; null
