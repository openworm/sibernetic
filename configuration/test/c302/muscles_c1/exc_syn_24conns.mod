TITLE Mod file for component: Component(id=exc_syn_24conns type=gradedSynapse)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: peer/v, on: Component(id=exc_syn_24conns type=gradedSynapse), from peer; null
