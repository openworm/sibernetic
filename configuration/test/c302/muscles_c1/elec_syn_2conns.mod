TITLE Mod file for component: Component(id=elec_syn_2conns type=gapJunction)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: peer/v, on: Component(id=elec_syn_2conns type=gapJunction), from peer; null
