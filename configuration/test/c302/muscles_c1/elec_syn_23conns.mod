TITLE Mod file for component: Component(id=elec_syn_23conns type=gapJunction)
...
NEURON {
    POINT_PROCESS elec_syn_23conns
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: peer/v, on: Component(id=elec_syn_23conns type=gapJunction), from peer; null
